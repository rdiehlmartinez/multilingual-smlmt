...
def convert_examples_to_features(
    ...
    for ex_index, example in enumerate(examples):
        ...
        # NOTE: XLM-R does not use token_type_ids, thus token_type_ids are all 0 -- for consistency
        # with other models, we add token_type_ids to XLM-R as well (but will be ignored)
